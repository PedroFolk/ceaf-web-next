        ...
        <main className="font-poppins">
            <div className="flex-col my-5 space-y-5 mx-3">
                <div className="sm:flex space-y-5 sm:space-y-0">
                    ...
                    <Link href="/PagCampoMaua" className="bg-mauaBrown ml-2.5 mr-5 rounded-3xl shadow-md flex flex-col md:flex-row sm:w-1/2 ">
                ...
                <Link href="PagCopaMaua" className="bg-mauaBrown ml-2.5 mr-5 flex flex-col rounded-3xl shadow-md sm:flex-row">
